...
void
cterm_in4::handle_dpt_open(rofl::crofdpt& dpt)
{
#if 0
	try {
		...
		rofcore::logging::error << "[cterm_in4][handle_dpt_open] dpt not found" << std::endl;
	} catch (rofl::eRofBaseNotConnected& e) {
		rofcore::logging::error << "[cterm_in4][handle_dpt_open] control channel is down" << std::endl;
	} catch (rofl::eRofSockTxAgain& e) {
		rofcore::logging::error << "[cterm_in4][handle_dpt_open] control channel congested" << std::endl;
	} catch (rofl::RoflException& e) {
		rofcore::logging::error << "[cterm_in4][handle_dpt_open] unexpected exception caught: " << e.what() << std::endl;
	}
#endif
}
...
void
cterm_in4::handle_dpt_close(rofl::crofdpt& dpt)
{
#if 0
	try {
		...
		rofcore::logging::error << "[cterm_in4][handle_dpt_close] dpt not found" << std::endl;
	} catch (rofl::eRofBaseNotConnected& e) {
		rofcore::logging::error << "[cterm_in4][handle_dpt_close] control channel is down" << std::endl;
	} catch (rofl::eRofSockTxAgain& e) {
		rofcore::logging::error << "[cterm_in4][handle_dpt_close] control channel congested" << std::endl;
	}
#endif
}
...
void
cterm_in6::handle_dpt_open(rofl::crofdpt& dpt)
{
#if 0
	try {
		rofl::openflow::cofflowmod fm(dpt.get_version());
		...
		rofcore::logging::error << "[cterm_in6][handle_dpt_open] dpt not found" << std::endl;
	} catch (rofl::eRofBaseNotConnected& e) {
		rofcore::logging::error << "[cterm_in6][handle_dpt_open] control channel is down" << std::endl;
	} catch (rofl::eRofSockTxAgain& e) {
		rofcore::logging::error << "[cterm_in6][handle_dpt_open] control channel congested" << std::endl;
	}
#endif
}
...
void
cterm_in6::handle_dpt_close(rofl::crofdpt& dpt)
{
#if 0
	try {
		state = STATE_DETACHED;
		...
		rofcore::logging::error << "[cterm_in6][handle_dpt_close] dpt not found" << std::endl;
	} catch (rofl::eRofBaseNotConnected& e) {
		rofcore::logging::error << "[cterm_in6][handle_dpt_close] control channel is down" << std::endl;
	} catch (rofl::eRofSockTxAgain& e) {
		rofcore::logging::error << "[cterm_in6][handle_dpt_close] control channel congested" << std::endl;
	}
#endif
}
