...
cdhcp_option_ia_prefix::cdhcp_option_ia_prefix() :
		cdhcp_option((size_t)sizeof(struct dhcp_option_ia_prefix_hdr_t)),
		hdr((struct dhcp_option_ia_prefix_hdr_t*)somem())
{
	set_code(DHCP_OPTION_IA_PREFIX);
	set_length(sizeof(struct dhcp_option_ia_prefix_hdr_t)); // ATTENTION: DO NOT FORGET THE IA-PREFIX-OPTIONS AT THE END!!!
}
...
cdhcp_option_ia_prefix::cdhcp_option_ia_prefix(
		const cdhcp_option_ia_prefix& opt) :
				cdhcp_option(opt)
{
	*this = opt;
}
...
cdhcp_option_ia_prefix::operator= (
		const cdhcp_option_ia_prefix& opt)
{
	if (this == &opt)
		return *this;
...
void
cdhcp_option_ia_prefix::validate()
{
...
uint8_t*
cdhcp_option_ia_prefix::resize(size_t len)
{
...
void
cdhcp_option_ia_prefix::pack(uint8_t *buf, size_t buflen)
{
	if (buflen < length())
...
void
cdhcp_option_ia_prefix::unpack(uint8_t *buf, size_t buflen)
{
	if (buflen < sizeof(struct dhcp_option_ia_prefix_hdr_t))
		throw eDhcpOptionBadSyntax();

	cdhcp_option::unpack(buf, sizeof(struct dhcp_option_ia_prefix_hdr_t));
...
uint32_t
cdhcp_option_ia_prefix::get_preferred_lifetime() const
{
...
void
cdhcp_option_ia_prefix::set_preferred_lifetime(uint32_t preferred_lifetime)
{
...
uint32_t
cdhcp_option_ia_prefix::get_valid_lifetime() const
{
...
void
cdhcp_option_ia_prefix::set_valid_lifetime(uint32_t valid_lifetime)
{
...
uint8_t
cdhcp_option_ia_prefix::get_prefixlen() const
{
...
void
cdhcp_option_ia_prefix::set_prefixlen(uint8_t prefixlen)
{
