...
void cethendpnt::handle_dpt_open(rofl::crofdpt &dpt) {
  try {
...
void cethendpnt::handle_dpt_close(rofl::crofdpt &dpt) {
  try {
    if (rofl::openflow::OFP_VERSION_UNKNOWN == dpt.get_version_negotiated()) {
      return;
    }
...
void cethendpnt::handle_packet_in(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
                                  rofl::openflow::cofmsg_packet_in &msg) {
  rofcore::logging::debug << "[cethendpnt][handle_packet_in] pkt received: "
                          << std::endl
                          << msg;
...
void cethendpnt::handle_flow_removed(rofl::crofdpt &dpt,
                                     const rofl::cauxid &auxid,
                                     rofl::openflow::cofmsg_flow_removed &msg) {
  // nothing to do
}

void cethendpnt::handle_port_status(rofl::crofdpt &dpt,
                                    const rofl::cauxid &auxid,
...
void cethendpnt::handle_error_message(rofl::crofdpt &dpt,
                                      const rofl::cauxid &auxid,
