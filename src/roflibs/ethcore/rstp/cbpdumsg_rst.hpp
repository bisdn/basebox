...
public:
	 ...
	 */
	uint8_t
	get_version1_length() const
	{ return version1_length; };
...
public:
	...
	friend std::ostream&
	operator<< (std::ostream& os, const cbpdumsg_rst& msg) {
