...
public:
   ...
   *
   */
  cprefix &operator=(const cprefix &prefix) {
    if (this == &prefix)
      return *this;
...
public:
  friend std::ostream &operator<<(std::ostream &os, const cprefix &prefix) {
...
public:
   ...
   *
   */
  cprefix_in4 &operator=(const cprefix_in4 &prefix) {
    if (this == &prefix)
      return *this;
   ...
   *
   */
  bool operator<(const cprefix_in4 &prefix) const {
...
public:
   ...
   *
   */
  const rofl::caddress_in4 &get_addr() const { return addr; };
...
public:
   ...
   *
   */
  friend std::ostream &operator<<(std::ostream &os, const cprefix_in4 &prefix) {
    os << rofcore::indent(0)
       << "<cprefix_in4 prefixlen: " << prefix.get_prefixlen() << " >"
       << std::endl;
...
public:
   ...
   *
   */
  cprefix_in6 &operator=(const cprefix_in6 &prefix) {
    if (this == &prefix)
      return *this;
    cprefix::operator=(prefix);
    addr = prefix.addr;
   ...
   *
   */
  bool operator<(const cprefix_in6 &prefix) const {
    return ((prefix.prefixlen < prefixlen) || (addr < prefix.addr));
  };
...
public:
   ...
   *
   */
  const rofl::caddress_in6 &get_addr() const { return addr; };
...
public:
   ...
   *
   */
  friend std::ostream &operator<<(std::ostream &os, const cprefix_in6 &prefix) {
    os << rofcore::indent(0)
       << "<cprefix_in6 prefixlen: " << prefix.get_prefixlen() << " >"
       << std::endl;
    os << rofcore::indent(2) << "<addr: >" << std::endl;
    {
      rofcore::indent i(2);
