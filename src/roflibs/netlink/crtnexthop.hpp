...
public:
   ...
   *
   */
  crtnexthop() : weight(0), ifindex(0), flags(0), realms(0){};
   ...
   *
   */
  crtnexthop(const crtnexthop &rtnxthop) { *this = rtnxthop; };

  /**
   *
   */
  crtnexthop &operator=(const crtnexthop &rtnxthop) {
    if (this == &rtnxthop)
      return *this;
   ...
   *
   */
  crtnexthop(struct rtnl_route *route, struct rtnl_nexthop *nxthop)
      : weight(0), ifindex(0), flags(0), realms(0) {
   ...
   *
   */
  bool operator==(const crtnexthop &rtnexthop) {
    return ((weight == rtnexthop.weight) && (ifindex == rtnexthop.ifindex) &&
            (flags == rtnexthop.flags) && (realms == rtnexthop.realms));
  };
...
public:
  friend std::ostream &operator<<(std::ostream &os, crtnexthop const &nxthop) {
    os << rofcore::indent(0) << "<crtnexthop: >" << std::endl;
    os << rofcore::indent(2) << "<weight: " << (int)nxthop.weight << " >"
       << std::endl;
    os << rofcore::indent(2) << "<ifindex: " << (int)nxthop.ifindex << " >"
       << std::endl;
    os << rofcore::indent(2) << "<flags: " << nxthop.flags << " >" << std::endl;
    os << rofcore::indent(2) << "<realms: " << (unsigned int)nxthop.realms
       << " >" << std::endl;
    return os;
  };
...
public:
  crtnexthop_find(const crtnexthop &rtnexthop) : rtnexthop(rtnexthop){};
  bool operator()(const crtnexthop &rtn) { return (rtnexthop == rtn); };
...
public:
   ...
   *
   */
  virtual ~crtnexthop_in4(){};

  /**
   *
   */
  crtnexthop_in4(const crtnexthop_in4 &nxthop) { *this = nxthop; };

  /**
   *
   */
  crtnexthop_in4 &operator=(const crtnexthop_in4 &nxthop) {
    if (this == &nxthop)
      return *this;
   ...
   *
   */
  crtnexthop_in4(struct rtnl_route *route, struct rtnl_nexthop *nxthop)
      : crtnexthop(route, nxthop) {
    ...
    std::string s_gw(
        nl_addr2str(rtnl_route_nh_get_gateway(nxthop), s_buf, sizeof(s_buf)));
    if (s_gw != "none") {
   ...
   *
   */
  bool operator==(const crtnexthop_in4 &rtnexthop) {
    return ((crtnexthop::operator==(rtnexthop)) &&
            (gateway == rtnexthop.gateway));
  };
...
public:
   ...
   *
   */
  const rofl::caddress_in4 &get_gateway() const { return gateway; };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  crtnexthop_in4 const &nxthop) {
...
public:
  crtnexthop_in4_find(const crtnexthop_in4 &rtnexthop) : rtnexthop(rtnexthop){};
  bool operator()(const crtnexthop_in4 &rta) { return (rtnexthop == rta); };
...
public:
   ...
   *
   */
  virtual ~crtnexthop_in6(){};

  /**
   *
   */
  crtnexthop_in6(const crtnexthop_in6 &nxthop) { *this = nxthop; };

  /**
   *
   */
  crtnexthop_in6 &operator=(const crtnexthop_in6 &nxthop) {
    if (this == &nxthop)
      return *this;
    crtnexthop::operator=(nxthop);
    gateway = nxthop.gateway;
   ...
   *
   */
  crtnexthop_in6(struct rtnl_route *route, struct rtnl_nexthop *nxthop)
      : crtnexthop(route, nxthop) {
   ...
   *
   */
  bool operator==(const crtnexthop_in6 &rtnexthop) {
    return ((crtnexthop::operator==(rtnexthop)) &&
            (gateway == rtnexthop.gateway));
  };
...
public:
   ...
   *
   */
  const rofl::caddress_in6 &get_gateway() const { return gateway; };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  crtnexthop_in6 const &nxthop) {
...
public:
  crtnexthop_in6_find(const crtnexthop_in6 &rtnexthop) : rtnexthop(rtnexthop){};
  bool operator()(const crtnexthop_in6 &rta) { return (rtnexthop == rta); };
