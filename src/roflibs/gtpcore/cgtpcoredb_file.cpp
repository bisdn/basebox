...
/*static*/ const std::string cgtpcoredb_file::DEFAULT_CONFIG_FILE =
    std::string("/usr/local/etc/roflibs.conf");
/*static*/ const std::string
    cgtpcoredb_file::GTPCORE_CONFIG_DPT_LIST("roflibs.gtpcore.datapaths");

void cgtpcoredb_file::read_config(const std::string &config_file,
  ...
  std::string path =
      prefix + std::string(".") + cgtpcoredb_file::GTPCORE_CONFIG_DPT_LIST;
...
void cgtpcoredb_file::parse_datapath(ethcore::cconfig &config,
...
void cgtpcoredb_file::parse_datapath_relay(ethcore::cconfig &config,
  ...
  entry.set_incoming_label().set_src_addr(
      (const char *)s_relay_gtp_incoming["saddr"]);
  ...
  entry.set_incoming_label().set_dst_addr(
      (const char *)s_relay_gtp_incoming["daddr"]);
  ...
  entry.set_incoming_label().set_teid(
      (unsigned int)s_relay_gtp_incoming["teid"]);
  ...
  entry.set_outgoing_label().set_src_addr(
      (const char *)s_relay_gtp_outgoing["saddr"]);
  ...
  entry.set_outgoing_label().set_dst_addr(
      (const char *)s_relay_gtp_outgoing["daddr"]);
  ...
  entry.set_outgoing_label().set_teid(
      (unsigned int)s_relay_gtp_outgoing["teid"]);
...
void cgtpcoredb_file::parse_datapath_term(ethcore::cconfig &config,
  ...
  entry.set_ingress_label().set_src_addr(
      (const char *)s_term_gtp_ingress["saddr"]);
  ...
  entry.set_ingress_label().set_dst_addr(
      (const char *)s_term_gtp_ingress["daddr"]);
  ...
  entry.set_egress_label().set_src_addr(
      (const char *)s_term_gtp_egress["saddr"]);
  ...
  entry.set_egress_label().set_dst_addr(
      (const char *)s_term_gtp_egress["daddr"]);
  ...
  if (s_term_inject.exists("netmask")) {
    entry.set_inject_filter().set_netmask(
        (const char *)s_term_inject["netmask"]);
  } else {
