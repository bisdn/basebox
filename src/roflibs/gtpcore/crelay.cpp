...
void crelay_in4::handle_dpt_open() {
  try {
    ...
    fm.set_instructions()
        ...
        .set_oxm(rofl::openflow::coxmatch_ofb_udp_src(
            label_out.get_saddr().get_port().get_value()));
    fm.set_instructions()
        .set_inst_apply_actions()
        .set_actions()
        .add_action_set_field(index++)
    ...
    rofcore::logging::error << "[crelay_in4][handle_dpt_open] dpt not found"
                            << std::endl;
  } catch (rofl::eRofBaseNotConnected &e) {
    rofcore::logging::error
        << "[crelay_in4][handle_dpt_open] control channel is down" << std::endl;
  } catch (rofl::eRofSockTxAgain &e) {
    rofcore::logging::error
        << "[crelay_in4][handle_dpt_open] control channel congested"
        << std::endl;
  } catch (rofl::RoflException &e) {
    rofcore::logging::error
        << "[crelay_in4][handle_dpt_open] unexpected exception caught: "
        << e.what() << std::endl;
  }
}

void crelay_in4::handle_dpt_close() {
  try {
    ...
    rofcore::logging::error << "[crelay_in4][handle_dpt_close] dpt not found"
                            << std::endl;
  } catch (rofl::eRofBaseNotConnected &e) {
    rofcore::logging::error
        << "[crelay_in4][handle_dpt_close] control channel is down"
        << std::endl;
  } catch (rofl::eRofSockTxAgain &e) {
    rofcore::logging::error
        << "[crelay_in4][handle_dpt_close] control channel congested"
        << std::endl;
  }
}

void crelay_in6::handle_dpt_open() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    rofcore::logging::error << "[crelay_in6][handle_dpt_open] dpt not found"
                            << std::endl;
  } catch (rofl::eRofBaseNotConnected &e) {
    rofcore::logging::error
        << "[crelay_in6][handle_dpt_open] control channel is down" << std::endl;
  } catch (rofl::eRofSockTxAgain &e) {
    rofcore::logging::error
        << "[crelay_in6][handle_dpt_open] control channel congested"
        << std::endl;
  }
}

void crelay_in6::handle_dpt_close() {
  try {
    state = STATE_DETACHED;
    ...
    rofcore::logging::error << "[crelay_in6][handle_dpt_close] dpt not found"
                            << std::endl;
  } catch (rofl::eRofBaseNotConnected &e) {
    rofcore::logging::error
        << "[crelay_in6][handle_dpt_close] control channel is down"
        << std::endl;
  } catch (rofl::eRofSockTxAgain &e) {
    rofcore::logging::error
        << "[crelay_in6][handle_dpt_close] control channel congested"
        << std::endl;
  }
}
