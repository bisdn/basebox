		...
		const rofl::caddress_in6& peer)
{
	try {
		...
		if (tft_match.get_matches().has_match(rofl::openflow::OXM_TLV_BASIC_IPV6_DST)) {
			fm.set_match().set_ipv6_dst(tft_match.get_ipv6_dst(), tft_match.get_ipv6_dst_mask());
		}
...
void
cterm_in4::handle_packet_in(
		rofl::crofdpt& dpt,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_packet_in& msg)
{
	if (has_peer_in4(msg.get_cookie())) {
		rofcore::logging::error << "[cterm_in4][handle_packet_in] oops, invalid packet-in for peer "
				<< get_peer_in4(msg.get_cookie()).str() << std::endl;
	} else
	if (has_peer_in6(msg.get_cookie())) {
		rofcore::logging::error << "[cterm_in4][handle_packet_in] oops, invalid packet-in for peer "
...
void
cterm_in4::handle_flow_removed(
		rofl::crofdpt& dpt,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_flow_removed& msg)
{
	if (has_peer_in4(msg.get_cookie())) {
		rofcore::logging::error << "[cterm_in4][handle_flow_removed] idle-timeout for peer "
				<< get_peer_in4(msg.get_cookie()).str() << std::endl;
...
void
cterm_in6::handle_packet_in(
		rofl::crofdpt& dpt,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_packet_in& msg)
{
	if (has_peer_in4(msg.get_cookie())) {
		rofcore::logging::error << "[cterm_in6][handle_packet_in] oops, invalid packet-in for peer "
				<< get_peer_in4(msg.get_cookie()).str() << std::endl;
	} else
	if (has_peer_in6(msg.get_cookie())) {
		rofcore::logging::error << "[cterm_in6][handle_packet_in] oops, invalid packet-in for peer "
...
void
cterm_in6::handle_flow_removed(
		rofl::crofdpt& dpt,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_flow_removed& msg)
{
	if (has_peer_in4(msg.get_cookie())) {
		rofcore::logging::error << "[cterm_in6][handle_flow_removed] idle-timeout for peer "
				<< get_peer_in4(msg.get_cookie()).str() << std::endl;
		drop_peer(get_peer_in4(msg.get_cookie()));
	} else
	if (has_peer_in6(msg.get_cookie())) {
