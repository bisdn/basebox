 ...
 */
class cterm : public roflibs::common::openflow::ccookie_owner {
public:
  /**
   *
   */
  ...
  cterm(const rofl::cdptid &dptid, uint8_t ofp_table_id,
      ...
      : state(STATE_DETACHED), dptid(dptid), ofp_table_id(ofp_table_id),
        devname(devname), idle_timeout(DEFAULT_IDLE_TIMEOUT){};
   ...
   *
   */
  cterm &operator=(const cterm &term) {
    if (this == &term)
      return *this;
    state = term.state;
    dptid = term.dptid;
...
public:
   ...
   *
   */
  const std::map<rofl::caddress_in4, uint64_t> &get_peers_in4() const {
    return peers_in4;
  };
   ...
   *
   */
  uint64_t add_peer(const rofl::caddress_in4 &peer) {
   ...
   *
   */
  uint64_t set_peer(const rofl::caddress_in4 &peer) {
    if (peers_in4.find(peer) == peers_in4.end()) {
      peers_in4[peer] =
          roflibs::common::openflow::ccookie_owner::acquire_cookie();
    }
   ...
   *
   */
  uint64_t get_peer(const rofl::caddress_in4 &peer) const {
    if (peers_in4.find(peer) == peers_in4.end()) {
   ...
   *
   */
  const rofl::caddress_in4 &get_peer_in4(uint64_t cookie) const {
   ...
   *
   */
  void drop_peer(const rofl::caddress_in4 &peer) {
    if (peers_in4.find(peer) == peers_in4.end()) {
      return;
    }
    roflibs::common::openflow::ccookie_owner::release_cookie(peers_in4[peer]);
   ...
   *
   */
  bool has_peer(const rofl::caddress_in4 &peer) const {
   ...
   *
   */
  bool has_peer_in4(uint64_t cookie) const {
...
public:
   ...
   *
   */
  const std::map<rofl::caddress_in6, uint64_t> &get_peers_in6() const {
    return peers_in6;
  };
   ...
   *
   */
  uint64_t add_peer(const rofl::caddress_in6 &peer) {
   ...
   *
   */
  uint64_t set_peer(const rofl::caddress_in6 &peer) {
    if (peers_in6.find(peer) == peers_in6.end()) {
      peers_in6[peer] =
          roflibs::common::openflow::ccookie_owner::acquire_cookie();
    }
   ...
   *
   */
  uint64_t get_peer(const rofl::caddress_in6 &peer) const {
    if (peers_in6.find(peer) == peers_in6.end()) {
      throw eTermNotFound("cterm::get_peer() peer not found");
    }
   ...
   *
   */
  const rofl::caddress_in6 &get_peer_in6(uint64_t cookie) const {
   ...
   *
   */
  void drop_peer(const rofl::caddress_in6 &peer) {
    if (peers_in6.find(peer) == peers_in6.end()) {
      return;
    }
    roflibs::common::openflow::ccookie_owner::release_cookie(peers_in6[peer]);
   ...
   *
   */
  bool has_peer(const rofl::caddress_in6 &peer) const {
   ...
   *
   */
  bool has_peer_in6(uint64_t cookie) const {
...
public:
  friend std::ostream &operator<<(std::ostream &os, const cterm &term) {
...
protected:
  ...
  virtual void
  handle_flow_removed(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
...
public:
  ...
  public:
    peer_find_by_cookie(uint64_t cookie) : cookie(cookie){};
    bool
    operator()(const std::pair<const rofl::caddress_in4, uint64_t> &p) const {
      return (p.second == cookie);
    };
    bool
    operator()(const std::pair<const rofl::caddress_in6, uint64_t> &p) const {
      return (p.second == cookie);
    };
  };
...
public:
  ...
  cterm_in4(const rofl::cdptid &dptid, uint8_t ofp_table_id,
            const std::string &devname, const clabel_in4 &label_egress,
            const clabel_in4 &label_ingress,
            const rofl::openflow::cofmatch &tft_match)
      : cterm(dptid, ofp_table_id, devname), label_egress(label_egress),
        label_ingress(label_ingress), tft_match(tft_match){};
   ...
   *
   */
  cterm_in4 &operator=(const cterm_in4 &term) {
    if (this == &term)
      return *this;
    cterm::operator=(term);
   ...
   *
   */
  bool operator<(const cterm_in4 &term) const {
...
public:
   ...
   *
   */
  const clabel_in4 &get_label_egress() const { return label_egress; };

  /**
   *
   */
  const clabel_in4 &get_label_ingress() const { return label_ingress; };

  /**
   *
   */
  const rofl::openflow::cofmatch &get_tft_match() const { return tft_match; };

public:
  /**
   *
   */
  void handle_dpt_open_egress();

  /**
   *
   */
  void handle_dpt_close_egress();

  /**
   *
   */
  void handle_dpt_open_ingress(const rofl::caddress_in4 &peer);

  /**
   *
   */
  void handle_dpt_open_ingress(const rofl::caddress_in6 &peer);

  /**
   *
   */
  void handle_dpt_close_ingress();
...
public:
  ...
  public:
    cterm_in4_find_by_devname(const std::string &devname) : devname(devname){};
...
public:
  ...
  cterm_in6(const rofl::cdptid &dptid, uint8_t ofp_table_id,
            const std::string &devname, const clabel_in6 &label_egress,
   ...
   *
   */
  cterm_in6 &operator=(const cterm_in6 &term) {
    if (this == &term)
      return *this;
    cterm::operator=(term);
    label_egress = term.label_egress;
   ...
   *
   */
  bool operator<(const cterm_in6 &term) const {
    return (label_ingress < term.label_ingress);
  };
...
public:
   ...
   *
   */
  const clabel_in6 &get_label_egress() const { return label_egress; };

  /**
   *
   */
  const clabel_in6 &get_label_ingress() const { return label_ingress; };
...
public:
  friend std::ostream &operator<<(std::ostream &os, const cterm_in6 &term) {
  ...
  public:
    cterm_in6_find_by_devname(const std::string &devname) : devname(devname){};
