...
void caddr_in4::handle_dpt_open() {
  try {
    ...
    fe.set_match().set_arp_tpa(rofcore::cnetlink::get_instance()
                                   .get_links()
                                   .get_link(ifindex)
                                   .get_addrs_in4()
                                   .get_addr(adindex)
    ...
    fe.set_match().set_ipv4_dst(rofcore::cnetlink::get_instance()
                                    .get_links()
                                    .get_link(ifindex)
                                    .get_addrs_in4()
                                    .get_addr(adindex)
    ...
    fe.set_instructions().clear();
    fe.set_instructions().add_inst_goto_table().set_table_id(in_ofp_table_id +
                                                             1);
    dpt.send_flow_mod_message(rofl::cauxid(0), fe);
    ...
    rofcore::logging::error << "[roflibs][ipcore][caddr_in4][handle_dpt_open] "
                               "unable to find data path"
                            << e.what() << std::endl
                            << *this;
  } catch (rofcore::eNetLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][caddr_in4][handle_dpt_open] "
                               "unable to find netlink link"
                            << e.what() << std::endl
                            << *this;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in4][handle_dpt_open] unable to find link"
        << e.what() << std::endl
        << *this;
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in4][handle_dpt_open] unexpected error"
        << std::endl
        << *this;
  }
}

void caddr_in4::handle_dpt_close() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    rofcore::logging::error << "[roflibs][ipcore][caddr_in4][handle_dpt_close] "
                               "unable to find data path"
                            << e.what() << std::endl;
  } catch (rofcore::eNetLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in4][handle_dpt_close] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][caddr_in4][handle_dpt_close] "
                               "unable to find address"
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in4][handle_dpt_close] unexpected error"
        << std::endl;
  }
}

void caddr_in4::handle_packet_in(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
                                 rofl::openflow::cofmsg_packet_in &msg) {
  rofcore::logging::debug << "[caddr_in4][handle_packet_in] pkt received: "
                          << std::endl
                          << msg;
...
void caddr_in6::handle_dpt_open() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    fe.set_match().set_ipv6_dst(rofcore::cnetlink::get_instance()
                                    .get_links()
                                    .get_link(ifindex)
                                    .get_addrs_in6()
                                    .get_addr(adindex)
    ...
    rofcore::logging::error << "[roflibs][ipcore][caddr_in6][handle_dpt_open] "
                               "unable to find data path"
                            << e.what() << std::endl;
  } catch (rofcore::eNetLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in6][handle_dpt_open] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in6][handle_dpt_open] unable to find link"
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in6][handle_dpt_open] unexpected error"
        << std::endl;
  }
}

void caddr_in6::handle_dpt_close() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    rofcore::logging::error << "[roflibs][ipcore][caddr_in6][handle_dpt_close] "
                               "unable to find data path"
                            << e.what() << std::endl;
  } catch (rofcore::eNetLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in6][handle_dpt_close] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][caddr_in6][handle_dpt_close] "
                               "unable to find address"
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][caddr_in6][handle_dpt_close] unexpected error"
        << std::endl;
  }
}

void caddr_in6::handle_packet_in(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
                                 rofl::openflow::cofmsg_packet_in &msg) {
  rofcore::logging::debug << "[caddr_in6][handle_packet_in] pkt received: "
                          << std::endl
                          << msg;
  // store packet in ethcore and thus, tap devices
  roflibs::eth::cethcore::set_eth_core(dpt.get_dptid())
