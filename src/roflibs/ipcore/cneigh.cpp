...
void cneigh_in4::update() {
  try {
    ...
    // the neighbour ...
    const rofcore::crtneigh_in4 &rtn = netlink.get_links()
                                           .get_link(get_ifindex())
                                           .get_neighs_in4()
                                           .get_neigh(get_nbindex());
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][update] dpt not found" << std::endl;
  } catch (rofcore::eNetLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][update] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtneigh::eRtNeighNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][update] unable to find neighbour"
        << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][update] unable to find address"
        << e.what() << std::endl;
  }
}

void cneigh_in4::handle_dpt_open() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    gm.set_buckets()
        ...
        .set_actions()
        .add_action_set_field(index++)
        .set_oxm(rofl::openflow::coxmatch_ofb_eth_src(eth_src));
    gm.set_buckets()
        .set_bucket(0)
        .set_actions()
        .add_action_set_field(index++)
        .set_oxm(rofl::openflow::coxmatch_ofb_eth_dst(eth_dst));
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][handle_dpt_open] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtneigh::eRtNeighNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in4][handle_dpt_open] "
                               "unable to find neighbour"
                            << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in4][handle_dpt_open] "
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][handle_dpt_open] unexpected error"
        << std::endl;
  }
}

void cneigh_in4::handle_dpt_close() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][handle_dpt_close] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtneigh::eRtNeighNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in4][handle_dpt_close]"
                               " unable to find neighbour"
                            << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in4][handle_dpt_close]"
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in4][handle_dpt_close] unexpected error"
        << std::endl;
  }

  state = STATE_DETACHED;
  try {
    rofl::crofdpt::get_dpt(dptid).release_group_id(group_id);
    group_id = 0;
  } catch (...) {
  }
}

void cneigh_in4::handle_packet_in(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
                                  rofl::openflow::cofmsg_packet_in &msg) {
  rofcore::logging::debug << "[cneigh_in4][handle_packet_in] pkt received: "
                          << std::endl
                          << msg;
...
void cneigh_in6::update() {
  try {
    ...
    // the neighbour ...
    const rofcore::crtneigh_in6 &rtn = netlink.get_links()
                                           .get_link(get_ifindex())
                                           .get_neighs_in6()
                                           .get_neigh(get_nbindex());
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][update] dpt not found" << std::endl;
  } catch (rofcore::eNetLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][update] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtneigh::eRtNeighNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][update] unable to find neighbour"
        << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][update] unable to find address"
        << e.what() << std::endl;
  }
}

void cneigh_in6::handle_dpt_open() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][handle_dpt_open] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtneigh::eRtNeighNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in6][handle_dpt_open] "
                               "unable to find neighbour"
                            << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in6][handle_dpt_open] "
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][handle_dpt_open] unexpected error"
        << std::endl;
  }
}

void cneigh_in6::handle_dpt_close() {
  try {
    rofl::crofdpt &dpt = rofl::crofdpt::get_dpt(dptid);
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][handle_dpt_close] unable to find link"
        << e.what() << std::endl;
  } catch (rofcore::crtneigh::eRtNeighNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in6][handle_dpt_close]"
                               " unable to find neighbour"
                            << e.what() << std::endl;
  } catch (rofcore::crtlink::eRtLinkNotFound &e) {
    rofcore::logging::error << "[roflibs][ipcore][cneigh_in6][handle_dpt_close]"
    ...
    rofcore::logging::error
        << "[roflibs][ipcore][cneigh_in6][handle_dpt_close] unexpected error"
        << std::endl;
  }
...
void cneigh_in6::handle_packet_in(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
                                  rofl::openflow::cofmsg_packet_in &msg) {
  rofcore::logging::debug << "[cneigh_in6][handle_packet_in] pkt received: "
                          << std::endl
                          << msg;
  // store packet in ethcore and thus, tap devices
  roflibs::eth::cethcore::set_eth_core(dpt.get_dptid())
